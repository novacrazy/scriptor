...
declare module _ {
    ...
    interface LoDashStatic {
         ...
         **/
        difference<T>( array? : Array<T>,
                       ...others : Array<T>[] ): T[];
        /**
         * @see _.difference
         **/
        difference<T>( array? : List<T>,
                       ...others : List<T>[] ): T[];
    }
    ...
    interface LoDashStatic {
         ...
         * @see _.first
         **/
        head<W, T>( array : Array<T>,
                    whereValue : W ): T[];

        /**
         * @see _.first
         **/
        head<W, T>( array : List<T>,
                    whereValue : W ): T[];
         ...
         * @see _.first
         **/
        take<W, T>( array : Array<T>,
                    whereValue : W ): T[];

        /**
         * @see _.first
         **/
        take<W, T>( array : List<T>,
                    whereValue : W ): T[];
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @param [thisArg] The this binding of callback.
         **/
        first( callback : ListIterator<T, boolean>,
         ...
         * @param [thisArg] The this binding of callback.
         **/
        head( callback : ListIterator<T, boolean>,
              thisArg? : any ): LoDashArrayWrapper<T>;
         ...
         * @param [thisArg] The this binding of callback.
         **/
        take( callback : ListIterator<T, boolean>,
              thisArg? : any ): LoDashArrayWrapper<T>;
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<Flat>( isShallow : boolean,
         ...
         * @see _.flatten
         **/
        flatten<Flat>( callback : ListIterator<T, Flat>,
                       thisArg? : any ): LoDashArrayWrapper<Flat>;
         ...
         * @see _.flatten
         **/
        flatten<Flat, W>( isShallow : boolean,
    ...
    interface LoDashStatic {
         ...
         * @see _.rest
         **/
        drop<W, T>( array : Array<T>,
                    whereValue : W ): T[];

        /**
         * @see _.rest
         **/
        drop<W, T>( array : List<T>,
                    whereValue : W ): T[];
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.xor
         **/
        xor( ...others : Array<T>[] ): LoDashArrayWrapper<T>;
        /**
         * @see _.xor
         **/
        xor( ...others : List<T>[] ): LoDashArrayWrapper<T>;
    }
    ...
    interface LoDashStatic {
         ...
         **/
        at<T>( collection : Array<T>,
               indexes : number[] ): T[];

        /**
         * @see _.at
         **/
        at<T>( collection : List<T>,
               indexes : number[] ): T[];

        /**
         * @see _.at
         **/
        at<T>( collection : Dictionary<T>,
               indexes : number[] ): T[];
    ...
    interface LoDashStatic {
         ...
         * @param _.pluck style callback
         **/
        find<W, T>( collection : Dictionary<T>,
                    whereValue : W ): T;
         ...
         * @param _.pluck style callback
         **/
        detect<W, T>( collection : Dictionary<T>,
                      whereValue : W ): T;
    ...
    interface LoDashStatic {
         ...
         **/
        map<T, TResult>( collection : Array<T>,
         ...
         **/
        map<T extends {}, TResult>( object : Dictionary<T>,
         ...
         * @see _.map
         **/
        collect<T, TResult>( collection : Array<T>,
                             callback : ListIterator<T, TResult>,
                             thisArg? : any ): TResult[];
         ...
         * @see _.map
         **/
        collect<T extends {}, TResult>( object : Dictionary<T>,
                                        callback : DictionaryIterator<T, TResult>,
                                        thisArg? : any ): TResult[];
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.map
         **/
        map<TResult>( callback : ListIterator<T, TResult>,
         ...
         * @param pluckValue _.pluck style callback
         **/
        map<TResult>( pluckValue : string ): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         **/
        collect<TResult>( callback : ListIterator<T, TResult>,
                          thisArg? : any ): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         **/
        collect<TResult>( pluckValue : string ): LoDashArrayWrapper<TResult>;
    }
    ...
    interface LoDashObjectWrapper<T> {
         ...
         * @see _.map
         **/
        map<T extends {}, TResult>( callback : ObjectIterator<T, TResult>,
                                    thisArg? : any ): LoDashArrayWrapper<TResult>;

        /**
         * @see _.map
         **/
        collect<T extends {}, TResult>( callback : ObjectIterator<T, TResult>,
                                        thisArg? : any ): LoDashArrayWrapper<TResult>;
    }
    ...
    interface LoDashArrayWrapper<T> {
         ...
         * @see _.sortBy
         **/
        sortBy<TSort>( callback? : ListIterator<T, TSort>,
                       thisArg? : any ): LoDashArrayWrapper<T>;
    ...
    interface LoDashStatic {
         ...
         **/
        memoize<T extends Function>( func : T,
                                     resolver? : Function ): T;
    }
    ...
    interface LoDashStatic {
         ...
         */
        mapValues<T, TResult>( obj : Dictionary<T>, callback : ObjectIterator<T, TResult>,
    ...
    interface LoDashObjectWrapper<T> {
         ...
         */
        mapValues<TValue, TResult>( callback : ObjectIterator<TValue, TResult>,
    ...
    interface LoDashStatic {
         ...
         * @return The accumulated value.
         **/
        transform<T, Acc>( collection : Array<T>,
         ...
         * @see _.transform
         **/
        transform<T, Acc>( collection : List<T>,
                           callback : MemoVoidIterator<T, Acc>,
                           accumulator : Acc,
                           thisArg? : any ): Acc;
         ...
         * @see _.transform
         **/
        transform<T, Acc>( collection : Dictionary<T>,
                           callback : MemoVoidIterator<T, Acc>,
                           accumulator : Acc,
                           thisArg? : any ): Acc;
