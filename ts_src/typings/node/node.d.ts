...
declare module "http" {
    ...
    export function createServer( requestListener? : ( request : IncomingMessage,
...
declare module "dns" {
    ...
    export function resolve( domain : string, rrtype : string,
...
declare module "fs" {
    ...
    export function open( path : string, flags : string,
    ...
    export function write( fd : number, buffer : Buffer, offset : number, length : number, position : number,
                           callback? : ( err : NodeJS.ErrnoException, written : number,
                                         buffer : Buffer ) => void ) : void;

    export function writeSync( fd : number, buffer : Buffer, offset : number, length : number,
    ...
    export function readSync( fd : number, buffer : Buffer, offset : number, length : number,
                              position : number ) : number;
...
declare module "tls" {
    ...
    export function connect( port : number, options? : ConnectionOptions,
                             secureConnectListener? : () =>void ) : ClearTextStream;
